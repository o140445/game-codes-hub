...
<div class="max-w-3xl w-full mx-auto px-4 py-12">
    ...
    <section class="text-center mb-12">
        ...
        <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-3">Terms of Service</h1>
    ...
    <section>
        <div class="bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-gray-200">
            <div class="space-y-10">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">2. Description of Service</h2>
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">3. User Responsibilities</h2>
                    <p class="text-gray-700 leading-relaxed mb-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">4. Intellectual Property Rights</h2>
                    <p class="text-gray-700 leading-relaxed mb-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">5. Privacy and Data Protection</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <!-- 6. Disclaimers -->
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">6. Disclaimers</h2>
                    <p class="text-gray-700 leading-relaxed mb-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">7. Limitation of Liability</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <!-- 8. Termination -->
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">8. Termination</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <!-- 9. Changes to Terms -->
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">9. Changes to Terms</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <!-- 10. Governing Law -->
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">10. Governing Law</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">11. Contact Information</h2>
                    <p class="text-gray-700 leading-relaxed">
