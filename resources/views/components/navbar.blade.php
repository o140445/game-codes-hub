...
<nav class="bg-gray-900 shadow-lg fixed top-0 left-0 w-full z-50" x-data="{ open: false }">
    ...
    <div x-show="open" x-transition class="md:hidden bg-gray-800 border-t border-gray-700">
        <ul class="px-4 py-2 space-y-2">
            ...
            <li><a href="/games" class="block py-2 text-gray-300 hover:text-yellow-400 transition-colors">Games</a></li>
            <li><a href="/codes" class="block py-2 text-gray-300 hover:text-yellow-400 transition-colors">Codes</a></li>
            <li><a href="/articles" class="block py-2 text-gray-300 hover:text-yellow-400 transition-colors">Articles</a></li>
        </ul>
    </div>
</nav>
