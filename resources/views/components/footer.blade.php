    ...
    <div class="max-w-6xl mx-auto px-4 gap-2">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            ...
            <div class="flex flex-wrap justify-center gap-4 text-sm">
                ...
                <a href="/privacy-policy" class="hover:text-yellow-400 transition-colors">Privacy Policy</a>
                <a href="/terms-of-service" class="hover:text-yellow-400 transition-colors">Terms of Service</a>
            </div>
        </div>
